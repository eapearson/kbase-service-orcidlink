...
def md_header(text: str, level: int = 1):
    header_tag = "#" * level
    header_anchor = f'<a name="header_{slugify(text)}"></a>'
...
- [Endpoints](#header_endoints)
    - [misc](#header_misc)
    - [link](#header_link)
    - [linking-sessions](#header_linking-sessions)
    - [orcid](#header_orcid)
    - [works](#header_works)
- [Types](#header_types)
- [Glossary](#header_glossary)
...
def generate_glossary():
    ...
    for term in terms:
        ...
        anchor = f'<a name="glossary_term_{slug}"></a>'
        if "link" in term:
            md.append(
                [
