...
The {generate_anchor_link('Endpoints', 'header')} section documents all REST endpoints, including the expected responses, input parameters 
and output JSON and type definitions.

The {generate_anchor_link('Types', 'header')} section defines all of the Pydantic models used in the codebase, most of which are in service of the 
