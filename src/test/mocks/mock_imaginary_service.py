    ...
    def do_POST(self):
        if self.path == "/services/imaginary_service":
            ...
            if method == "ImaginaryService.foo":
                ...
                return self.send_json(self.success_response({
                ...
                self.increment_method_call_count(method, "error")
                return self.send_json_error(self.error_data_response(
                    some_error,
                    call_id="12345"
                ))
                ...
                self.increment_method_call_count(method, "success")
                return self.send_json(self.some_result(
                    some_result,
                    call_id="12345"
                ))
                ...
                self.increment_method_call_count(method, "error")
                self.send_json(self.error_response(METHOD_NOT_FOUND, "Method not found"))
