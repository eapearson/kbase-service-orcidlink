...
The [Endpoints](#user-content-header_endpoints) section documents all REST endpoints, including the expected responses, input parameters 
and output JSON and type definitions.

The [Types](#user-content-header_types) section defines all of the Pydantic models used in the codebase, most of which are in service of the 
...
<a name="header_type_kbasesdkconfig"></a>
##### KBaseSDKConfig
...
<a name="header_type_kbaseserviceconfig"></a>
##### KBaseServiceConfig
